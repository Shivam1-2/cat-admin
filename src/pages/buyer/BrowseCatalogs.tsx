    ...
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-emerald-100 p-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-xl font-semibold text-gray-900">{cart.reduce((sum, item) => sum + item.quantity, 0)}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {currentProducts.map((product) => (
          <div key={product.id} className="bg-white rounded-lg shadow-sm border border-emerald-100 overflow-hidden">
            <div className="p-4">
              <div className="flex justify-between items-start mb-3">
                <div className="flex items-center">
                  <div className="h-10 w-10 bg-emerald-100 rounded-md flex items-center justify-center">
            ...
            <div className="px-4 py-3 bg-emerald-25 border-t border-emerald-100">
              <div className="flex justify-between items-center">
                <button 
