    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Stay updated with order status and catalog changes</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-emerald-100 p-8 text-center">
        ...
        <p className="text-gray-600 max-w-md mx-auto">
          We're working on a notification system to keep you updated on order status changes, 
          price expiry alerts, new product availability, and more.
        </p>
      </div>
    </div>
  );
