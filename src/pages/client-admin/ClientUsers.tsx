    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Manage users within your organization</p>
          <p className="text-xs text-purple-600 mt-1">Note: User status is managed by Client Admin. Master Admin can override these settings.</p>
        </div>
        <button 
      ...
      {/* Search and Filters */}
      <div className="bg-white rounded-lg shadow-sm border border-purple-100 p-4 space-y-4">
          ...
          <table className="min-w-full divide-y divide-purple-200">
            ...
            <tbody className="bg-white divide-y divide-purple-100">
              {filteredUsers.map((user) => (
                <tr key={user.id} className="hover:bg-purple-25">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                      user.role === 'client_admin' ? 'bg-purple-100 text-purple-800' : 'bg-indigo-100 text-indigo-800'
                    }`}>
