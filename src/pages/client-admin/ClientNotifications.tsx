    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Notification system coming soon</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-purple-100 p-8 text-center">
        ...
        <p className="text-gray-600 max-w-md mx-auto">
          We're working on a comprehensive notification system to keep you updated on important events, 
          price changes, order updates, and more.
        </p>
      </div>
    </div>
  );
